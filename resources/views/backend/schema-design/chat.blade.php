        ...
        <div class="typing-container relative d-flex">
            <div class="typing-content">
                <div class="typing-textarea form-group">
                    <textarea id="chat-input" spellcheck="false" placeholder="Enter a prompt here" required></textarea>
                    <span id="send-btn" class=" bg-gray-500 text-white hover:text-white material-symbols-rounded"><svg xmlns="http://www.w3.org/2000/svg"
...
<script src="{{ asset('backend/js/schema-design-chat.js') }}"></script>
@endsection
